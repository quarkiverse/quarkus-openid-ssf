...
/**
 * Configuration for the {@code quarkus-openid-ssf-receiver} extension. All properties
 * are prefixed with {@code quarkus.openid-ssf.receiver.}.
 *
 * <p>
...
public interface SsfReceiverConfig {
     ...
     *
     * <p>
     * Useful for {@code %test.quarkus.openid-ssf.receiver.enabled=false} or runtime
     ...
     * {@code io.quarkiverse.ssf.receiver.runtime.event.SsfAliases#resolveEventTypeRef(String)}
    ...
    interface Oauth2 {
         ...
         * in config (e.g. {@code quarkus.openid-ssf.receiver.oauth2.scopes=ssf.read,ssf.manage});
